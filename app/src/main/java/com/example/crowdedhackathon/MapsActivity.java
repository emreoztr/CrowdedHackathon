    ...
    private void giveFeatureToButtons(){
        ...
        addHMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(_markers.size() == 2){
                    try {
                        new HeatMapCalc(_map, _markers, 200, 30, 0);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
        ...
        Button addLessHMap = findViewById(R.id.add_lessheat_map);
        addLessHMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(_markers.size() == 2){
                    try {
                        new HeatMapCalc(_map, _markers, 200, 30, 1);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
